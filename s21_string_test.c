...
#endif
#ifdef STRCHR
#define DO_TEST() s21_strchr_test()
#endif
#ifdef STRSTR
#define DO_TEST() s21_strstr_test()
#endif
...
int s21_strchr_test();
int s21_strstr_test();
void result_strlen(int res, int ret);
void result_str(int res);
void result_strchr(int res);
...
int s21_strcmp_test() {
    int res = 0;
    char *test1_1 = "123", *test1_2 = "123", *test2_1 = "test", *test2_2 = "tets", *test3_1 = "abcc",
         *test3_2 = "abc";
    printf("%s %s\n", test1_1, test1_2);
...
int s21_strchr_test() {
    int res = 0;
    char *test1 = "chunga-changa", *test2 = "Kazan", *test3 = "text";
    char *symbol1 = "u", *symbol2 = "n", *symbol3 = "z";
    printf("%s %s\n", test1, symbol1);
    res = s21_strchr(test1, symbol1);
    printf("%s %s\n", test1, symbol1);
    result_strchr(res);
    printf("%s %s\n", test2, symbol2);
    res = s21_strchr(test2, symbol2);
    printf("%s %s\n", test2, symbol2);
    result_strchr(res);
    printf("%s %s\n", test3, symbol3);
    res = s21_strchr(test3, symbol3);
    printf("%s %s\n", test3, symbol3);
    result_strchr(res);
    return 0;
}
...
int s21_strstr_test() {
    int res = 0;
    char *test1_1 = "qwertyuiop", *test1_2 = "asdfghjkl", *test1_3 = "zxcvbnm";
    char *test2_1 = "qwer", *test2_2 = "jkl", *test2_3 = "zxcvbmn";
    printf("%s %s\n", test1_1, test2_1);
    res = s21_strstr(test1_1, test2_1);
    printf("%s %s\n", test1_1, test2_1);
    result_strchr(res);
    printf("%s %s\n", test1_2, test2_2);
    res = s21_strstr(test1_2, test2_2);
    printf("%s %s\n", test1_2, test2_2);
    result_strchr(res);
    printf("%s %s\n", test1_3, test2_3);
    res = s21_strstr(test1_3, test2_3);
    printf("%s %s\n", test1_3, test2_3);
    result_strchr(res);
    return 0;
}
